...
# String to pass to linker to pick up the zlibtcl library from its
# installed directory.
zlibtcl_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib/Img1.4.6 -lzlibtcl1.2.8.1'
...
# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib/Img1.4.6 -lzlibtclstub1.2.8.1'
...
# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_PATH='/home/dours_d/Documents/Python3/lib/Img1.4.6/libzlibtclstub1.2.8.1.a'
